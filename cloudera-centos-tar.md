...
Ubuntu版本 : cloudera-manager-precise-cm5.3.2_amd64.tar.gz
...
Ubuntu下载：(对应版本precise)
CDH-5.3.2-1.cdh5.3.2.p0.10-precise.parcel
CDH-5.3.2-1.cdh5.3.2.p0.10-precise.parcel.sha1
manifest.json
